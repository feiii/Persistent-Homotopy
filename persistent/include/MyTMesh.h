...
{
  public:
    CMyEdge() : m_sharp(false), m_idx(0), m_pair(NULL), m_generator(false), m_direction(1), m_visited(false){}; //add m_direction to tell the direciton of the edge, used in persistence homotopy Van Kampen
...
{
  public:
    CMyFace() : m_idx(0), m_pair(NULL), m_generator(false), m_visited(false) {};
